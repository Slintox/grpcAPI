...
type CalculatorClient interface {
	Add(ctx context.Context, in *CalculatorRequest, opts ...grpc.CallOption) (*CalculatorResponseWithStatus, error)
}
...
func (c *calculatorClient) Add(ctx context.Context, in *CalculatorRequest, opts ...grpc.CallOption) (*CalculatorResponseWithStatus, error) {
	out := new(CalculatorResponseWithStatus)
...
type CalculatorServer interface {
	Add(context.Context, *CalculatorRequest) (*CalculatorResponseWithStatus, error)
...
func (UnimplementedCalculatorServer) Add(context.Context, *CalculatorRequest) (*CalculatorResponseWithStatus, error) {
